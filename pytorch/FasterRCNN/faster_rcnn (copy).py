...
class FasterRCNN(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # fasterrcnn takes images only for eval() mode
...
def run_cli():
    ...
    #from VOC.vocdetection_datamodule import VOCDetectionDataModule
    ...
    from BogO.segmentation_datamodule import BogODataModule
    ...
    '''
    args.num_classes = datamodule

    model = FasterRCNN(**vars(args))
    trainer = pl.Trainer(gpus=1, max_epochs=20, accumulate_grad_batches=4)
