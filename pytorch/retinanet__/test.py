...
def draw_on_image(image_path, boxes, scores, classes, label_map):
    """
...
from utils.pascal.pascal_utils import convert_annotations_to_df
test_df  = convert_annotations_to_df('/home/markpp/datasets/VOC/VOCdevkit/VOC2012/Annotations', '/home/markpp/datasets/VOC/VOCdevkit/VOC2012/JPEGImages', image_set="train")
...
from utils.pascal.pascal_transforms import generate_pascal_category_names
pred_image = draw_on_image(image_path, boxes, scores, labels, label_map=generate_pascal_category_names(test_df))
